(function() {
    ...
    var timelinechart = new ApexCharts(document.querySelector("#chart-3"), options);
    ...
    var options = {
        series: [{
            name: '',
            data: [44, 55, 57, 56, 61, 58, 63, 60, 66, 68]
        }, {
            name: '',
            data: [76, 85, 101, 98, 87, 105, 91, 114, 94, 102]
        }, {
            name: '',
        ...
        xaxis: {
            categories: ['03:00AM', '06:00AM', '09:00AM', '11:00AM', '01:00AM', '03:00PM', '06:00PM', '08:00PM', '10:00PM'],
    ...
    var barchart = new ApexCharts(document.querySelector("#chart-4"), options);
    barchart.render();
    ...
    document.querySelector('#six_months')
        .addEventListener('click', function(e) {
            basechart.zoomX(
    ...
    document.querySelector('#one_year')
        .addEventListener('click', function(e) {
            basechart.zoomX(
                new Date('2018-09-19T00:30:00.000Z').getTime(),
